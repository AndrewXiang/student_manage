...
<html>
  ...
  <body bgcolor="#FFFFFF">
    <s:form action="addXs.action" method="post" enctype="multipart/form-data">
    <table border="0" cellpadding="0" cellspacing="1">
      <tr>
        <td><s:textfield name="xs.xh" label="学号"></s:textfield></td>
      </tr>
      <tr>
        <td><s:textfield name="xs.xm" label="姓名"></s:textfield></td>
      </tr>
      <tr>
        <td><s:radio name="xs.xb" value="1" list="#{1:'男',0:'女'}" label="性别"></s:radio></td>
      </tr>
      <tr>
        <td><s:select name="xs.zyb.id" list="list" listKey="id" listValue="zym" label="专业"></s:select></td>
      </tr>
      <tr>
        <td><s:textfield name="xs.cssj" label="出生时间" onclick="setDay(this);"></s:textfield></td>
      </tr>
      <tr>
        <td><s:textfield name="xs.zxf" label="总学分"></s:textfield></td>
      </tr>
      <tr>
        <td><s:textfield name="xs.bz" label="备注"></s:textfield></td>
      </tr>
      <tr>
        <td><s:file name="zp" label="照片"></s:file></td>
      </tr>
